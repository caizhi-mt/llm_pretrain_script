...
for flag_name in MATE_GROUPED_GEMM MATE_USE_MAIN_GRAD MATE_FLASH_ATTN MATE_CACHE_MUBIN_DISPATCH MATE_DEFER_DEEPEP_COUNTS MUSA_COMPACT_PERMUTE MUSA_NATIVE_ROPE MUSA_FUSED_MLA_ROPE; do
